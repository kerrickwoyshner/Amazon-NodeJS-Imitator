...
6. You will be prompted with the options to view product sales by department, create a new department, or quit the application
7. Any changes to the department records are reflected on the Sequel Pro or MySQL database
